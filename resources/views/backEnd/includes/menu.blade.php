...
?>
<style>.nav-active-primary .nav-link.active, .nav-active-primary .nav > li.active > a {
...
<div id="aside" class="app-aside modal fade folded md nav-expand">
    <div class="left navside dark dk" layout="column">
        <div class="navbar navbar-md no-radius" style="background-color:#ffffff;">
            <!-- brand -->
            <a class="navbar-brand" href="{{ route('adminHome') }}">
               
                <span class="hidden-folded inline"><img src="{{ URL::to('backEnd/assets/images/logo.png') }}" alt="Control"></span>
            </a>
            <!-- / brand -->
        </div>
